...
\definecolor{turonblue}{HTML}{005080}
\definecolor{turonmagenta}{HTML}{9A005D}
\definecolor{turongray}{HTML}{555555}
\definecolor{turonlightgray}{HTML}{777777}
...
% Main section headings: compact, tracked, uppercase small-caps.
% Slightly quieter than the chapter-opening title.

\newcommand{\turonsectiontitle}[1]{%
  \textls[35]{\MakeTextUppercase{#1}}%
}
...
\titleformat{\section}
  {\normalfont\small\scshape\bfseries\raggedright\color{black}}
  {\thesection}
  {1.0em}
  {\turonsectiontitle}
...
%   \color{black}%
%   \noindent
%   \llap{\raisebox{.01em}{\scriptsize\color{turonblue!55!black}\synopsismarker}\hspace{.7em}}%
%   {\normalfont\scshape\textls[45]{Synopsis}}\quad
%   \ignorespaces
% }{%
%   \par\endgroup\addvspace{0pt}%
% }
...
% Turon-like opening paragraph: marker + uppercase/small-caps lead phrase.
% \newcommand{\openingpara}[2]{%
%   \par\addvspace{0pt}%
%   \noindent\llap{\raisebox{.01em}{\scriptsize\color{turonblue!55!black}\synopsismarker}\hspace{.7em}}%
%   {\scshape\textls[8]{\MakeTextUppercase{#1}}} #2\par\addvspace{0pt}%
% }
...
\renewcommand{\cftpartfont}{%
  \tocnohyphen\normalfont\small\scshape\bfseries\color{turonblue}%
}
\renewcommand{\cftpartpagefont}{%
  \normalfont\small\bfseries\color{turonmagenta}%
}

% Chapters: compact small caps, like the reference.
\renewcommand{\cftchapfont}{%
  \tocnohyphen\normalfont\small\scshape\bfseries\color{black}%
}
...
% Subsections: available if tocdepth is later changed back to 2.
...
% Tighter dot leaders. Lower number = denser dots.
\renewcommand{\cftdotsep}{3.8}
\renewcommand{\cftchapleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsubsecleader}{\cftdotfill{\cftdotsep}}

% Vertical rhythm.
\setlength{\cftbeforepartskip}{.85em}
\setlength{\cftbeforechapskip}{.34em}
\setlength{\cftbeforesecskip}{.08em}
