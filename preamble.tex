...
% \newcommand{\chaptersource}[1]{%
%   \par\addvspace{.95\baselineskip}%
%   \noindent\textcolor{black!22}{\rule{.42\linewidth}{0.3pt}}%
%   \par\vspace{.32\baselineskip}%
%   {\footnotesize\RaggedRight
%     {\scshape\textls[30]{\textcolor{turonblue}{Chapter source}}}\quad
%     #1\par
%   }%
% }
