...
Chapter 2 establishes the theoretical and disciplinary foundations of the thesis. It situates the dissertation within Human--Building Interaction and introduces the relevant scholarship on indoor human experience, affect, Affective Interaction, biophilic design, multisensory interaction, and technologically mediated environments.

Chapter 3 presents the scoping review of human-experience design research in indoor environments. It maps the forms of experience addressed across the literature, the design mechanisms through which they are pursued, and the interactive interventions used to support them.

Chapter 4 presents the situated occupant studies. It examines what Affective Interaction reveals about how people sense, interpret, anticipate, and make meaning within indoor environments.

Chapter 5 presents the expert interviews and expert design sessions on multisensory biophilic environments. It develops the biophilic design framework for HBI and considers its implications for HCI.

Chapter 6 presents the AI-transformed indoor soundscape prototype and its empirical investigation. It examines how everyday office sound can be transformed into a responsive nature-like soundscape and how this proposition is perceived by participants and experts.

Chapter 7 synthesises the findings and returns to the central research question. It discusses the theoretical, methodological, and design implications of affective HBI, the limitations of the dissertation, and directions for future research.

The central argument of the dissertation is that the complexity of indoor experience should not remain a general premise of HBI. It can be specified through closer examination of the forms of experience addressed in the field, studied through an affective lens, translated through biophilic design, and examined through concrete interactive systems. In this way, the thesis contributes a structured approach for moving from the recognition of experiential complexity towards the design of future indoor environments.
