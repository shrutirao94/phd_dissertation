\begin{figure*}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/study_2/bodymaps-sample.jpg}
...
\paragraph{\textbf{W1 --- Interpreting the Somatic Experience Over Time}}
\label{theme:w1}
...
\paragraph{\textbf{W2 --- Anticipating Disruption Before It Happens}}
\label{theme:w2}
...
\paragraph{\textbf{W3 --- Constructing Spatial Purpose}}
\label{theme:w3}
...
\paragraph{\textbf{W4 --- Micro-adjustments and Low-effort Escalations}}
\label{theme:w4}
...
\paragraph{\textbf{W5 --- Making Sense of Smartness}}
\label{theme:w5}
